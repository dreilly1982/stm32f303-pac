...
pub type FRES_W<'a, const O: u8> = crate::BitWriter<'a, u32, USB_CNTR_SPEC, bool, O>;
...
pub type RESETM_W<'a, const O: u8> = crate::BitWriter<'a, u32, USB_CNTR_SPEC, bool, O>;
