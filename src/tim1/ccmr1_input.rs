...
pub type IC1PCS_R = crate::FieldReader<u8, u8>;
#[doc = "Field `IC1PCS` writer - Input capture 1 prescaler"]
pub type IC1PCS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CCMR1_INPUT_SPEC, u8, u8, 2, O>;
...
impl R {
    ...
    pub fn ic1pcs(&self) -> IC1PCS_R {
        IC1PCS_R::new(((self.bits >> 2) & 3) as u8)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ic1pcs(&mut self) -> IC1PCS_W<2> {
        IC1PCS_W::new(self)
    }
    #[doc = "Bits 4:7 - Input capture 1 filter"]
    #[inline(always)]
