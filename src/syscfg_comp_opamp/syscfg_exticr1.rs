...
pub type EXTI0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SYSCFG_EXTICR1_SPEC, u8, u8, 4, O>;
...
pub type EXTI1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SYSCFG_EXTICR1_SPEC, u8, u8, 4, O>;
...
pub type EXTI2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SYSCFG_EXTICR1_SPEC, u8, u8, 4, O>;
...
pub type EXTI3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SYSCFG_EXTICR1_SPEC, u8, u8, 4, O>;
impl R {
