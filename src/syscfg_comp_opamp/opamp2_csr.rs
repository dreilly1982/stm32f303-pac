...
pub type OPAMP2EN_R = crate::BitReader<bool>;
#[doc = "Field `OPAMP2EN` writer - OPAMP2 enable"]
pub type OPAMP2EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP2_CSR_SPEC, bool, O>;
...
pub type VP_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OPAMP2_CSR_SPEC, u8, u8, 2, O>;
...
pub type TCM_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP2_CSR_SPEC, bool, O>;
...
pub type VMS_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP2_CSR_SPEC, bool, O>;
...
pub type VPS_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OPAMP2_CSR_SPEC, u8, u8, 2, O>;
...
pub type CAL_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CAL_SEL` writer - Calibration selection"]
pub type CAL_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OPAMP2_CSR_SPEC, u8, u8, 2, O>;
...
pub type USER_TRIM_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP2_CSR_SPEC, bool, O>;
...
pub type TRIMOFFSETP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OPAMP2_CSR_SPEC, u8, u8, 5, O>;
...
pub type LOCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP2_CSR_SPEC, bool, O>;
impl R {
