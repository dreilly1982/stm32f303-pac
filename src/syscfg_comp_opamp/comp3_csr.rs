...
pub type COMP3INSEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `COMP3INSEL` writer - Comparator 3 inverting input selection"]
pub type COMP3INSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, COMP3_CSR_SPEC, u8, u8, 3, O>;
...
pub type COMP3_OUT_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `COMP3_OUT_SEL` writer - Comparator 3 output selection"]
pub type COMP3_OUT_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, COMP3_CSR_SPEC, u8, u8, 4, O>;
