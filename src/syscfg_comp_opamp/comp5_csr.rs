...
pub type COMP5INSEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `COMP5INSEL` writer - Comparator 5 inverting input selection"]
pub type COMP5INSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, COMP5_CSR_SPEC, u8, u8, 3, O>;
...
pub type COMP5_OUT_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `COMP5_OUT_SEL` writer - Comparator 5 output selection"]
pub type COMP5_OUT_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, COMP5_CSR_SPEC, u8, u8, 4, O>;
