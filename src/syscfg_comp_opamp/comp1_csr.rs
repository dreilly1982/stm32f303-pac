...
pub type COMP1INSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, COMP1_CSR_SPEC, u8, u8, 3, O>;
#[doc = "Field `COMP1_OUT_SEL` reader - Comparator 1 output selection"]
pub type COMP1_OUT_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `COMP1_OUT_SEL` writer - Comparator 1 output selection"]
pub type COMP1_OUT_SEL_W<'a, const O: u8> =
