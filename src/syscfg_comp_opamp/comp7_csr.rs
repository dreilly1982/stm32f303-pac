...
pub type COMP7INSEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `COMP7INSEL` writer - Comparator 7 inverting input selection"]
pub type COMP7INSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, COMP7_CSR_SPEC, u8, u8, 3, O>;
...
pub type COMP7_OUT_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `COMP7_OUT_SEL` writer - Comparator 7 output selection"]
pub type COMP7_OUT_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, COMP7_CSR_SPEC, u8, u8, 4, O>;
