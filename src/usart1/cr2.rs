...
pub type ADD0_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ADD0` writer - Address of the USART node"]
pub type ADD0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CR2_SPEC, u8, u8, 4, O>;
#[doc = "Field `ADD4` reader - Address of the USART node"]
pub type ADD4_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ADD4` writer - Address of the USART node"]
pub type ADD4_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CR2_SPEC, u8, u8, 4, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn add0(&mut self) -> ADD0_W<24> {
        ADD0_W::new(self)
    }
    #[doc = "Bits 28:31 - Address of the USART node"]
    #[inline(always)]
    #[must_use]
    pub fn add4(&mut self) -> ADD4_W<28> {
        ADD4_W::new(self)
    }
